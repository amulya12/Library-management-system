...
printf("\xB2\xB2\xB2\xB2\xB2\xB2 LIBRARY MANAGEMENT SYSTEM \xB2\xB2\xB2\xB2\xB2\xB2");
gotoxy(20,5);
printf("\xB2\xB2\xB2\xB2\xB2\xB2 YOU HAVE SUCCESFULLY LOGGED IN AS A STUDENT \xB2\xB2\xB2\xB2\xB2\xB2");
gotoxy(20,6);
printf("\xB2\xB2\xB2\xB2\xB2\xB2 ENTER YOUR BRANCH \xB2\xB2\xB2\xB2\xB2\xB2");
gotoxy(20,8);
...
void  pop(char list[5][100],int limit){
	if(limit==-1){
		printf("List empty\n");
		exit(0);
	}
...
gotoxy(50,20);
printf("Press 1 to go back to Mainmenu ");
scanf("%d",&e);
switch(e){
case 1:
	mainmenu();
...
void mainmenu()
{
    ...
    gotoxy(20,23);
    printf("\xDB\xDB\xDB\xDB\xB2 10. Close Application");
   	gotoxy(20,25);
    printf("------------------------------------------");
    gotoxy(20,26);
    t();
...
void deletebooks()    //delete items from file fp
{
    system("cls");
    int d;
    char another='y';
...
void issuebooks(void)  //issuing books 
{
    int t;
    ...
    case '1':  //issue book
    {
        ...
        while(another=='y')
        {
            ...
            if(checkid(t)==0) //if books are present in the library.
            {
                 gotoxy(10,8);
                 printf("The book record is available");
                 gotoxy(10,9);
...
//          printf("Current date=%d-%d-%d",d.day,d.month,d.year);
    ...
    break;
    case '3':   //search issued books by particular id
    {
        system("cls");
        gotoxy(10,6);
